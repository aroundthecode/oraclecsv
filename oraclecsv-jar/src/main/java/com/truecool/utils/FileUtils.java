...
/**
 * Created by IntelliJ IDEA. User: mpzarde Date: Apr 26, 2006 Time: 10:35:21 AM
 */
	...
	public static boolean moveFiles(String srcDirPath, String destDirPath, String oldPattern, String newPattern) {
		...
		if (fileList != null) {
			...
			for (int index = 0; (long) index < iNumCount_root; index++) {
				...
				String newFileName = String.valueOf(String.valueOf(
						(new StringBuffer(String.valueOf(String.valueOf(destDirPath)))).append("/").append(fileName)));
